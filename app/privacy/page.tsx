    ...
    <main className="min-h-screen flex flex-col bg-[var(--landing-cream)]">
      ...
      <section className="flex-1 container mx-auto px-4 py-8">
        <div className="max-w-2xl mx-auto prose prose-slate">
          ...
          <p className="text-[var(--landing-navy)]/70 mb-2">
            We use the following third-party services to operate passinburgering:
          </p>
          <ul className="list-disc pl-6 text-[var(--landing-navy)]/70 mb-4 space-y-1">
          ...
          <p className="text-[var(--landing-navy)]/70 mb-4">
            ...
            or email us at{" "}
            <a href="mailto:privacy@passinburgering.com" className="text-[var(--landing-orange)] hover:underline">
