...
const securityHeaders = [
  ...
  { key: "X-DNS-Prefetch-Control", value: "on" },
  {
    ...
    value: [
      ...
      "script-src 'self' 'unsafe-inline' https://www.googletagmanager.com https://www.google-analytics.com https://*.clerk.accounts.dev https://*.clerk.com https://clerk.passinburgering.com https://challenges.cloudflare.com https://*.i.posthog.com",
